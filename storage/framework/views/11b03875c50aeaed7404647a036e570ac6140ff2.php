        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="text-align: right">
                    <a href="/admin/news/create" class="btn btn-primary">Ավելացնել Նորություն</a>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/admin/news/<?php echo e($d->id); ?>/edit" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                        <button onclick="admin.deleteAction('<?php echo e($d->id); ?>', '/admin/news/')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
