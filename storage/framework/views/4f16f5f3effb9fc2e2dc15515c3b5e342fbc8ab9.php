            ...
            <div class="row">
                <form action="/admin/news" method="post" class="col-md-12">
                    ...
                    <div class="form-group" style="text-align: center">
                        <img onclick="admin.chooseImage(this)" class="img-responsive img_choose_div" height="200px" src="<?php if(isset($data->image) && $data->image != '-'): ?> <?php echo e(asset('storage/app'.$data->image)); ?> <?php else: ?> <?php echo e(asset('storage/app/public/images.png')); ?> <?php endif; ?>" alt="">
