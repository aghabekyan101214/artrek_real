            ...
            <div class="row">
                <form action="/admin/languages" method="post" class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required name="name" placeholder="Language" class="form-control" id="language" value="<?php echo e(old('name')); ?>" >
                    </div>
                    <div class="form-group">
                        <?php echo '<div style="color: red;">'. $errors->first('code') . '</div>'; ?>
                        <label for="code" class="control-label">Code</label>
                        <input type="text" name="code" placeholder="Code" class="form-control" id="code" value="<?php echo e(old('code')); ?>" >
                    </div>
                    <div class="form-group">
                        <?php echo '<div style="color: red;">'. $errors->first('default') . '</div>'; ?>
                        <label for="default" class="control-label">Default</label>
                        <input type="number" name="default" placeholder="default" class="form-control" id="default" value="<?php echo e(old('default')); ?>" >
                    </div>
