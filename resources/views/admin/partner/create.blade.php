...
@section('content')
    <div class="col-md-12">
        <div class="container">
            <div class="row">
                <form action="/admin/partner" method="post" class="col-md-12">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group mb-10">
                        <label for="" class="control-label">Հղում</label>
                        <input type="text" class="form-control" name="url" placeholder="Հղում">
                    </div>
