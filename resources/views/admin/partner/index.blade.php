                        ...
                        <tbody>
                            @foreach($data as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->header }}</td>
                                    <td>
                                        <a href="/admin/partner/{{$d->id}}/edit" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                        <button onclick="admin.deleteAction('{{ $d->id }}', '/admin/partner/')" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
